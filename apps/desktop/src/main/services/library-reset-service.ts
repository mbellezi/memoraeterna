...
export class LibraryResetService {
  ...
  public async reset(): Promise<LibraryResetResult> {
    ...
    await pool.query(`truncate table
      obsidian_editorial_operations, atomic_note_revisions, obsidian_projection_revisions, monitoring_operations, similarity_debug_results, similarity_debug_runs,
