...
A7 has passed independent interpretation, reviewed evolution, native, PostgreSQL and DEV preservation gates; A8 remains **planned**. Each implementation task must report its
